 ...
 */
final class Version20191230093618 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE post_liked_by (post_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_DDF224CA4B89032C (post_id), INDEX IDX_DDF224CAA76ED395 (user_id), PRIMARY KEY(post_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE post_liked_by ADD CONSTRAINT FK_DDF224CA4B89032C FOREIGN KEY (post_id) REFERENCES micro_post (id)');
        $this->addSql('ALTER TABLE post_liked_by ADD CONSTRAINT FK_DDF224CAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
